...
docker: selfsignedcert docker_kill package
	...
	sleep 10
	docker exec nextcloud /bin/bash -c "mkdir -p /var/www/html/custom_apps && chown www-data:www-data /var/www/html/custom_apps"
